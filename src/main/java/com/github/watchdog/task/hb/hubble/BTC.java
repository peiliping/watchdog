...
public class BTC extends AbstractHubbleWithCommonRL {
    ...
    public BTC(String market, String name, String path) {
        ...
        initPositionManager(new PositionManager(path));
    }
    ...
    @Override public AbstractHubble init() {
        ...
        //initLongTermRules(CandleType.HOUR_4);
        {
            ...
            //            IRule rsiOverFalling = new ThresholdSRL(buildName(candleType, "RSI_OverFalling"), rsiPIS, 25, NumCompareFunction.LTE).and(newLowest).overTurn(true)
            //            .period();
