...
public class ComparePIS<I extends Element, SR extends Element> extends PairIndicatorSeries<I, BooleanET, SR> {


    private CustomCompare<SR> customCompare;


    public ComparePIS(String name, int size, long interval, IndicatorSeries<I, SR> first, IndicatorSeries<I, SR> second, CustomCompare<SR> customCompare) {
